...
Page({
  ...
  req:function(token,image){
    var that=this
    http.req("https://aip.baidubce.com/api/v1/solution/direct/imagerecognition/combination?access_token="+token,{
      "image": image,
      "scenes":["advanced_general","object_detect"]
    },function(res){
      wx.hideLoading()
      console.log(JSON.stringify(res.data.result.advanced_general.result_num))
      var num=res.data.result.advanced_general.result_num
      var results = res.data.result.advanced_general.result
